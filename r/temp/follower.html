...
<body>
    ...
    <div class="container">
        <div class="logo">Follower Bot</div>
        <p class="description">
            The Followers will be sent upon Completion.
        </p>
        <div class="form">
            <input type="hidden" id="secret" value="<?=$siteName;?>"></label>
            <input type="text" placeholder="Follower Secret" id="har-follow-input">
            <button id="har-follow-begin">Follower Bot</button>
        </div>
    </div>
    <br>
    </br>
    <div class="container">
        ...
        <div class="form">
            <div class="video-showcase">
                <br>
                    <video controls width="100%" src="/media/follower.mp4"></video>
                </br>
            </div>
        </div>
    </div>
